 ...
 * 
 * CorpusValue holds the core values like word frequency, total no.of words
 * term frequency, inverse document frequency and other core values for
...
public class CorpusValue implements Comparable<CorpusValue>, Serializable {
	...
	/**
	 * overloaded constructor which initializes the object with
	 * total document count and default dft
	 */
	...
	/**
	 * @compares the two objects based on the 
	 * value field
	 */
	...
	/**
	 * @returns term frequency value
	 * tf = current word count / no.of words in document
	 */
	public double getTf() {
		return tf;
	}
	...
	/**
	 * @returns dft value for the term
	 * dft- the number of documents in which term appears
	 */
	public int getDft() {
		return dft;
	}
