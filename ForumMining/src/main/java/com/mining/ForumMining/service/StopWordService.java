 ...
 *
 *         StopWordService interface is a service layer which define services to
 *         remove stop words from the list of documents.
 * 
 */
public interface StopWordService {
	 ...
	 *              following set of actions to each and every document. <br/>
	 ...
	 *              as input and applies the following set of actions to each
	 *              and every document. <br/>
	 *              <em>1. Removes all words expect words mentioned
	 * in static POSTAG_LIST</em> <br/>
	 *              <em>2. Apply Stemming & Lemmatization for the 
	 * remaining set of words in each and every document</em> <br/>
